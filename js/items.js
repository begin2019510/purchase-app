...
function openDetailModal(id){
  ...
  ${item['图片']?`<div style="margin-top:8px"><img src="${item['图片'].startsWith('kv:')?API_BASE + '/api/images?key='+encodeURIComponent(item['图片'].slice(3))+'&token='+encodeURIComponent(getPin()):item['图片']}" style="max-width:100%;max-height:300px;border-radius:10px;cursor:pointer" onclick="showFullscreenImg(this.src)"></div>`:''}
