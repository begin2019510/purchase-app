...
function showApprovalModal(id){
  ...
  btn.onclick=async function(){
    ...
    if(r&&r.error){toast('更新失败');await loadAll();}else{loadTodos().catch(function(){})}if(next==='已取消'||next==='已退'){if(typeof todoList!=='undefined'){todoList=todoList.filter(function(t){return t.linkId!==id});}}
  };
